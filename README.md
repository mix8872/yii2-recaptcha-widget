...
[![Packagist](https://img.shields.io/packagist/dt/mix8872/yii2-recaptcha-widget.svg)]() [![Packagist](https://img.shields.io/packagist/v/mix8872/yii2-recaptcha-widget.svg)]()  [![license](https://img.shields.io/badge/License-MIT-yellow.svg)]()
...
```
php composer.phar require --prefer-dist "mix8872/yii2-recaptcha-widget" "*"
```

or add

```json
"mix8872/yii2-recaptcha-widget" : "*"
```
...
'components' => [
    'reCaptcha' => [
        'class' => 'mix8872\yii2\recaptcha\ReCaptchaConfig',
...
'container' => [
    'definitions' => [
        mix8872\yii2\recaptcha\ReCaptcha2::className() => function ($container, $params, $config) {
            return new mix8872\yii2\recaptcha\ReCaptcha2(
                'your siteKey v2',
                '', // default
                $config
            );
        },
        mix8872\yii2\recaptcha\ReCaptchaValidator2::className() => function ($container, $params, $config) {
            return new mix8872\yii2\recaptcha\ReCaptchaValidator2(
                'your secret key v2',
                '', // default
                null, // default
                null, // default
